...
set cindent
set cmdheight=2
set errorfile=/var/folders/t6/rs4ks2815_v70py8ppjpfn9w0000gn/T/v447KRz/0
...
set matchtime=8
set mouse=a
set path=.,/usr/include,,,res/layout,res/layout-finger,res/values,res/drawable,res/drawable-mdpi,res/drawable-hdpi,res/menu,assets,js,css,img,/usr/lib/python2.7,rms
set ruler
...
set shortmess=aoO
badd +3 ~/workspace/rms-server/run.py
badd +0 ~/workspace/rms-server/rms/rms.py
silent! argdel *
edit ~/workspace/rms-server/run.py
...
setlocal tabstop=4
setlocal tags=~/workspace/rms-server/.git/python.tags,~/workspace/rms-server/.git/tags,./tags,tags
...
wincmd w
argglobal
edit ~/workspace/rms-server/rms/rms.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal balloonexpr=
